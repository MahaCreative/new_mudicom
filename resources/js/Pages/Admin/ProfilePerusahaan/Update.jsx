...
export default function Update(props) {
    ...
    useEffect(() => {
        ...
        setData((prev) => ({
            ...
            kode_pos: kantor.kode_pos,
            telepon: kantor.telepon,
            email: kantor.email,
            status: kantor.status,
            deskripsi: kantor.deskripsi,
            logo: "",
            thumbnail: "",
            visi: kantor.visi.visi,
            misi: misi,
            sosial_media: sosmed,
        }));
        setPreviewLogo("/storage/" + kantor.logo);
        setPreviewThumbnail("/storage/" + kantor.thumbnail);
    }, []);
    console.log(kantor);
